...
`Chat.documentIds` is the persistent/default document scope of a conversation. It means all documents attached to the chat, not the documents used by the latest query.
